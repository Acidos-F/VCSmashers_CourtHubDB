...
INSERT INTO bookings (user_id, title, description, activity_name, num_of_participants, fee_per_head, total_fee, event_date, event_time, status)
VALUES (1, 'Morning Pickleball', 'Friendly match with friends', 'Pickleball', 5, 200.00, 1000.00, '2025-10-12', '09:00:00', 'CONFIRMED');
